...
export const PALETTES: Record<LocationId, Palette> = {
  ...
  blackseaice: {
    baseGradient: "linear-gradient(150deg, #0b1a26, #040506)",
    block1: "#e0f7ff",
    block1Opacity: 0.10,
    block2: "#38bdf8",
    block2Opacity: 0.10,
    mark: "ICE",
    markStroke: "rgba(224, 247, 255, 0.24)",
    markLeft: "2%",
    markTop: "58%",
    cardMarkSize: "90px",
    pane1Bg: "rgba(224, 247, 255, 0.07)",
    pane1Border: "rgba(224, 247, 255, 0.2)",
    pane2Bg: "rgba(56, 189, 248, 0.07)",
    pane2Border: "rgba(56, 189, 248, 0.18)",
  },
  zestafoni: {
